...
<head>
    ...
    <link rel="stylesheet" href="${ path }/resources/css/board/wherego/wherego_petsitter_detail.css">
    ...
    <section class="wg_8">
        <div class="wg5_top">
                ...
                <div style="--swiper-navigation-color: #fff; --swiper-pagination-color: #fff" class="swiper mySwiper2">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <img src="${ path }/resources/images/wherego/펫시터1.png" />
                        </div>
                        <div class="swiper-slide">
                            <img src="${ path }/resources/images/wherego/펫시터2.png" />
                        </div>
                        <div class="swiper-slide">
                            <img src="${ path }/resources/images/wherego/펫시터3.png" />
                        </div>
                        <div class="swiper-slide">
                            <img src="${ path }/resources/images/wherego/펫시터4.png" />
                        </div>
                    </div>
            ...
            <div class="wg5t_2">
                ...
                <div class="wg5t2_option">
                    ...
                    <div class="wg5t2_icon">
                        <img src="${ path }/resources/images/wherego/중형견.png" alt="">
                        <p>중형견</p>
                    </div>
                    <div class="wg5t2_icon">
        ...
        <div class="wg5_bottom">
            ...
            <div class="wg5b_content">
                <div id="wg5bc_2" class="content_container content_container_01 active">
                    ...
                    <details class="wg5bc_inf" open>
                        <summary class="wg5bci_1">펫시터 정보</summary>
                        <div class="wg5bci_content">
                            <h5>커피</h5>
                            <ul>
                                <li>아메리카노 - 5,000원</li>
        ...
        <script>
            jQuery(document).ready(function ($) {
                ...
                var btnAll = $('.wg_8 .wg5_bottom .wg5b_btn section .btnBox');
