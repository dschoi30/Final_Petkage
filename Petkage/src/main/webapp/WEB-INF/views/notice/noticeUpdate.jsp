...
<body>
    ...
    <section class="nt">
        <div class="container py-5">
            ...
            <form action="${ path }/notice/noticeUpdate" method="post" enctype="multipart/form-data">
                ...
                <div class="nt_small">
                    <div class="nt_write">
                        <div style="height: 60px; margin-bottom: 20px; border-bottom: #D6d6d6 2px solid;">
                            ...
                            <input class="nt_search" type="text" name="title" value="${ notice.title }" required="required">
                        </div>
                            <textarea style="width: 100%;" id="summernote" name="content" required="required">${ notice.content }</textarea>
                            <br><br>
                            <button type="submit" class="b-btn" style="font-size:14px; margin-right: 20px;">수정</button>
