      ...
      <p class="mypagept" style="width: 1110px; height: 50px; font-size: 32px; font-weight: 700; line-height: 100%; text-align: center; color: #803D3D;">찜 목록</p>
		<div class="wg6_bottom" style="float: left;">
            <div class="wg6b_ca">
                ...
                <c:set var="rename_wherego" value="${ heart.renameImg }" />
                <div class="wgc6_card">
	                <a href="${ path }/wherego/wherego_cafe_detail?no=${ heart.spotNo }">
	                    <div class="card_img" value="${ heart.renameImg }">
