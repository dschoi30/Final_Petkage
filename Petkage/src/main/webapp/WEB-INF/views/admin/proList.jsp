        ...
        <div class="container-fluid" style="height: 100%; ">
          <div class="row">
            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 sidebar d-md-block collapse" style="padding-left: 0%; border: 0px;" >
              ...
              <a href="${ path }/admin/proList" class="list-group-item list-group-item-action active py-3 lh-tight" aria-current="true">
              ...
              <div class="container" style="width: 80%;">
                ...
                <div class="table-responsive">
                  ...
                  <div style="text-align: center;">
                    <br>
                    <button class="btn btn-customlr btn-sm" onclick="location.href='${ path }/admin/proList?page=${ pageInfo.prevPage }'">&lt;</button>
                    &nbsp;&nbsp;
                    <c:forEach begin="${ pageInfo.startPage }" end="${ pageInfo.endPage }" varStatus="status">
                      ...
                      <c:if test="${ status.current != pageInfo.currentPage }">
                        <button class="btn btn-custom btn-sm" onclick="location.href='${ path }/admin/proList?page=${ status.current }'">${ status.current }</button>
                        &nbsp;&nbsp;
                      </c:if>
                    </c:forEach>
                    <button class="btn btn-customlr btn-sm" onclick="location.href='${ path }/admin/proList?page=${ pageInfo.nextPage }'">&gt;</button>   
                  </div>
